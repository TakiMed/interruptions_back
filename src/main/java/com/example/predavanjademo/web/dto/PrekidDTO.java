...
public class PrekidDTO {
    ...
    public String toString() {
        return "PrekidDTO{" +
                "id=" + id +
                ", brojPrekida=" + brojPrekida +
                ", region='" + region + '\'' +
                ", grad='" + grad + '\'' +
                ", brojPotrosaca=" + brojPotrosaca +
                ", tip1='" + tip1 + '\'' +
                ", tip2='" + tip2 + '\'' +
                ", tip3='" + tip3 + '\'' +
                ", tip4='" + tip4 + '\'' +
                ", eeo='" + eeo + '\'' +
                ", kablovskiVod=" + kablovskiVod +
                ", brojDepese='" + brojDepese + '\'' +
                ", planPocetak=" + planPocetak +
                ", planKraj=" + planKraj +
                ", realizacijaPocetak=" + realizacijaPocetak +
                ", realizacijaKraj=" + realizacijaKraj +
                '}';
    }
}
